                        ...
                        <div className="col-lg-9 scrollbar-isl overflow-auto" style={{maxHeight: 700}}>
                            <div className="tab-content" id="v-pills-tabContent">
                                <div className="tab-pane text-center fade active show" id="v-pills-prestation" role="tabpanel" aria-labelledby="v-pills-prestation-tab">
                                    ...
                                    <Thematics artistType={this.props.role.charAt(0).toUpperCase() + this.props.role.slice(1)}/>
                                    <PrestationInformation aartistType={this.props.role.charAt(0).toUpperCase() + this.props.role.slice(1)}/>
                                    <div className="pt-5 mb-2">
                                        ...
                                        <div className="image-buttons">
                                            <input onClick={(e) => FunctionTools.ImageClick(e)} type="image" className="show-image-1" src="https://images.unsplash.com/photo-1445810694374-0a94739e4a03?w=100&h=100&fit=crop" alt=""/>
                                            <input onClick={(e) => FunctionTools.ImageClick(e)} type="image" className="show-image-2" src="https://images.unsplash.com/photo-1515260268569-9271009adfdb?w=100&h=100&fit=crop" alt=""/>
                                            <input onClick={(e) => FunctionTools.ImageClick(e)} type="image" className="show-image-3" src="https://images.unsplash.com/photo-1506045412240-22980140a405?w=100&h=100&fit=crop" alt=""/>
                                            <input onClick={(e) => FunctionTools.ImageClick(e)} type="image" className="show-image-4" src="https://images.unsplash.com/photo-1514041181368-bca62cceffcd?w=100&h=100&fit=crop" alt=""/>
                                            <input onClick={(e) => FunctionTools.ImageClick(e)} type="image" className="show-image-5" src="https://images.unsplash.com/photo-1488190211105-8b0e65b80b4e?w=100&h=100&fit=crop" alt=""/>
                                            <input onClick={(e) => FunctionTools.ImageClick(e)} type="image" className="show-image-6" src="https://images.unsplash.com/photo-1486334803289-1623f249dd1e?w=100&h=100&fit=crop" alt=""/>
                                        </div>
                                    </div>
                                </div>
...
export default connect(mapStateToProps, null)(EditPrestation);
