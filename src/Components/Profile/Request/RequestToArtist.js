            ...
            <Modal visible={true} width="700" height="700" animationType='slide'>
                ...
                <div className="form-material" style={{background:"lightslategray", height:"100%", borderRadius:"5px"}}>
                    ...
                    <div className="col text-center">
                        <h4 className="text-green text-monospace">Request to Artist</h4>
                        <div className="body">
                            ...
                            <button id="update-profile" className="btn btn-outline-success btn-sm pl-4 pr-4" onClick={(e) => this.handleSubmit(e)}>Send Request</button>
                        </div>
                    </div>
                </div>
            </Modal>
