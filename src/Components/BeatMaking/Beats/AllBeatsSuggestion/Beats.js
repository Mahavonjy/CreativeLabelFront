            ...
            axios.get(Conf.configs.ServerApi + url_, {headers: new_headers}).then(resp => {
                ...
                this.setState({genre: ""}, () => {
                    ...
                    for (let row_ in this.props.beats) {
                        FunctionTools.AddForPlay(row_, null, this, this.props.beats[row_]['id'])
                    }
                });
            }).catch(err => {
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="mt-8 d-flex">
                                                            <button type="button" id="Offers"
                                                                    ...
                                                                    data-toggle="modal"
                                                                    data-target="#exampleModalOffers">Offers
                                                            </button>
                                                                ...
                                                                <div className="modal-dialog" role="document"
                                                                    ...
                                                                    <div className="modal-content transparent border-0">
                                                                        <div className="modal-header">
                                                                            <h1 className="pt-2">Creative Beats
                                                                                Offers</h1>
                                                                            <button type="button"
                                                            ...
                                                            <div className="dropdown">
                                                                ...
                                                                <div className="dropdown-menu text-center"
                                                                    ...
                                                                    <div className="md-form my-0">
                                                                        ...
                                                                        <datalist
                                                                            id="music-genre">{this.props.AllMediaGenre.map((val, index) =>
                                                                            <option key={index}
                                                                                    value={val}/>)}</datalist>
                                                                    </div>
                                                                </div>
