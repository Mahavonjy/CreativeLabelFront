...
!function (t) {
    ...
    !function (e, n) {
        ...
        function k(t, e, n, i, r) {
            for (var o, s, l, u, c, d, f = e.createDocumentFragment(), h = [], p = 0, g = t.length; p < g; p++) if (o = t[p], o || 0 === o) if ("object" === a(o)) xt.merge(h, o.nodeType ? [o] : o);else if (oe.test(o)) {
            ...
            for (f.textContent = "", p = 0; o = h[p++];) if (i && xt.inArray(o, i) > -1) r && r.push(o);else if (c = xt.contains(o.ownerDocument, o), s = E(f.appendChild(o), "script"), c && x(s), n) for (d = 0; o = s[d++];) ie.test(o.type || "") && n.push(o);
        ...
        function P(t, e, n, i, r, o) {
            ...
            if (null == i && null == r ? (r = n, i = n = void 0) : null == r && ("string" == typeof n ? (r = i, i = void 0) : (r = i, i = n, n = void 0)), r === !1) r = I;else if (!r) return t;
        ...
        function $(t, e) {
            ...
            if (1 === e.nodeType) {
                if (Ut.hasData(t) && (o = Ut.access(t), s = Ut.set(e, o), u = o.events)) {
                    ...
                    for (r in u) for (n = 0, i = u[r].length; n < i; n++) xt.event.add(e, r, u[r][n]);
                }
        ...
        function M(t, e, n, i) {
            ...
            if (f && (r = k(e, t[0].ownerDocument, !1, t, i), o = r.firstChild, 1 === r.childNodes.length && (r = o), o || i)) {
                ...
                if (l) for (c = a[a.length - 1].ownerDocument, xt.map(a, N), d = 0; d < l; d++) u = a[d], ie.test(u.type || "") && !Ut.access(u, "globalEval") && xt.contains(c, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? xt._evalUrl && xt._evalUrl(u.src) : s(u.textContent.replace(he, ""), c, u));
            }
        ...
        function B(t) {
            ...
            for (var e = t[0].toUpperCase() + t.slice(1), n = Se.length; n--;) if (t = Se[n] + e, t in _e) return t;
        }
        ...
        function X(t, e, n) {
            for (var i, r = (Z.tweeners[e] || []).concat(Z.tweeners["*"]), o = 0, s = r.length; o < s; o++) if (i = r[o].call(n, e, t)) return i;
        }
        ...
        function J(t, e) {
            ...
            for (n in t) if (i = y(n), r = e[i], o = t[n], Array.isArray(o) && (r = o[1], o = t[n] = o[0]), n !== i && (t[i] = o, delete t[n]), s = xt.cssHooks[i], s && "expand" in s) {
        ...
        function Z(t, e, n) {
            ...
            for (J(c, u.opts.specialEasing); o < s; o++) if (i = Z.prefilters[o].call(u, t, c, u.opts)) return _t(i.stop) && (xt._queueHooks(u.elem, u.opts.queue).stop = i.stop.bind(i)), i;
        ...
        function it(t, e, n, i) {
            ...
            });else if (n || "object" !== a(e)) i(t, e);else for (r in e) it(t + "[" + r + "]", e[r], n, i);
        }
        ...
        function rt(t) {
            return function (e, n) {
                ...
                if (_t(n)) for (; i = o[r++];) "+" === i[0] ? (i = i.slice(1) || "*", (t[i] = t[i] || []).unshift(n)) : (t[i] = t[i] || []).push(n);
            };
        }
        ...
        xt.fn = xt.prototype = {
            ...
            for ("boolean" == typeof s && (u = s, s = arguments[a] || {}, a++), "object" == typeof s || _t(s) || (s = {}), a === l && (s = this, a--); a < l; a++) if (null != (t = arguments[a])) for (e in t) n = s[e], i = t[e], s !== i && (u && i && (xt.isPlainObject(i) || (r = Array.isArray(i))) ? (r ? (r = !1, o = n && Array.isArray(n) ? n : []) : o = n && xt.isPlainObject(n) ? n : {}, s[e] = xt.extend(u, o, i)) : void 0 !== i && (s[e] = i));
            ...
            each: function (t, e) {
                var n,
                    i = 0;
                if (l(t)) for (n = t.length; i < n && e.call(t[i], i, t[i]) !== !1; i++);else for (i in t) if (e.call(t[i], i, t[i]) === !1) break;
                return t;
            },
            trim: function (t) {
            ...
            map: function (t, e, n) {
                var i,
                    ...
                    o = 0,
                    s = [];
                if (l(t)) for (i = t.length; o < i; o++) r = e(t[o], o, n), null != r && s.push(r);else for (o in t) r = e(t[o], o, n), null != r && s.push(r);
                return ht.apply([], s);
            },
            guid: 1,
            support: St
        ...
        var Ot = function (t) {
            function e(t, e, n, i) {
                ...
                if (!i && ((e ? e.ownerDocument || e : B) !== L && D(e), e = e || L, $)) {
                    ...
                    if (_.qsa && !V[t + " "] && (!H || !H.test(t))) {
                        if (1 !== p) f = e, c = t;else if ("object" !== e.nodeName.toLowerCase()) {
            ...
            function p(t, e, n) {
                ...
                return e.first ? function (e, n, r) {
                    ...
                    } else for (; e = e[i];) if (1 === e.nodeType || s) if (d = e[R] || (e[R] = {}), c = d[e.uniqueID] || (d[e.uniqueID] = {}), r && r === e.nodeName.toLowerCase()) e = e[i] || e;else {
            ...
            function b(t) {
                for (var e, n, i, r = t.length, o = C.relative[t[0].type], s = o || C.relative[" "], a = o ? 1 : 0, l = p(function (t) {
                    ...
                    return e = null, r;
                }]; a < r; a++) if (n = C.relative[t[a].type]) c = [p(g(c), n)];else {
                ...
                var r = n.length > 0,
                    ...
                    s = function (i, s, a, l, u) {
                        ...
                        for (u && (I = s === L || s || u); p !== S && null != (c = b[p]); p++) {
                            if (o && c) {
                                for (d = 0, s || c.ownerDocument === L || (D(c), a = !$); f = t[d++];) if (f(c, s || L, a)) {
                                    l.push(c);
                                    break;
                                }
                        ...
                        if (h += p, r && p !== h) {
                            ...
                            if (i) {
                                if (h > 0) for (; p--;) g[p] || m[p] || (m[p] = X.call(l));
                                m = v(m);
                            }
                        ...
                        return 1 === i && 0 === r ? function (t) {
                            ...
                            if (m) {
                                ...
                                if (p = [s ? m.firstChild : m.lastChild], s && y) {
                                    for (f = m, d = f[R] || (f[R] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), u = c[t] || [], h = u[0] === z && u[1], b = h && u[2], f = h && m.childNodes[h]; f = ++h && f && f[g] || (b = h = 0) || p.pop();) if (1 === f.nodeType && ++b && f === e) {
                                        c[t] = [z, h, b];
                                        break;
                                    }
                                } else if (y && (f = e, d = f[R] || (f[R] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), u = c[t] || [], h = u[0] === z && u[1], b = h), b === !1) for (; (f = ++h && f && f[g] || (b = h = 0) || p.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++b || (y && (d = f[R] || (f[R] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), c[t] = [z, b]), f !== e)););
            ...
            return f.prototype = C.filters = C.pseudos, C.setFilters = new f(), x = e.tokenize = function (t, n) {
                ...
                if (n = n || [], 1 === c.length) {
                    ...
                    for (r = ht.needsContext.test(t) ? 0 : o.length; r-- && (s = o[r], !C.relative[a = s.type]);) if ((l = C.find[a]) && (i = l(s.matches[0].replace(bt, wt), yt.test(o[0].type) && d(e.parentNode) || e))) {
        ...
        xt.filter = function (t, e, n) {
            ...
            find: function (t) {
                ...
                if ("string" != typeof t) return this.pushStack(xt(t).filter(function () {
                    for (e = 0; e < i; e++) if (xt.contains(r[e], this)) return !0;
                }));
        ...
        var Lt,
            ...
            $t = xt.fn.init = function (t, e, n) {
                ...
                if (n = n || Lt, "string" == typeof t) {
                    ...
                    if (i[1]) {
                        if (e = e instanceof xt ? e[0] : e, xt.merge(this, xt.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : ct, !0)), Dt.test(i[1]) && xt.isPlainObject(e)) for (i in e) _t(this[i]) ? this[i](e[i]) : this.attr(i, e[i]);
                        return this;
                    }
        ...
        xt.fn.extend({
            has: function (t) {
                ...
                return this.filter(function () {
                    for (var t = 0; t < n; t++) if (xt.contains(this, e[t])) return !0;
                });
            },
            closest: function (t, e) {
                ...
                if (!Pt.test(t)) for (; i < r; i++) for (n = this[i]; n && n !== e; n = n.parentNode) if (n.nodeType < 11 && (s ? s.index(n) > -1 : 1 === n.nodeType && xt.find.matchesSelector(n, t))) {
                    o.push(n);
                    break;
                }
        ...
        xt.Callbacks = function (t) {
            ...
            var e,
                ...
                l = -1,
                u = function () {
                    for (r = r || t.once, i = e = !0; s.length; l = -1) for (n = s.shift(); ++l < o.length;) o[l].apply(n[0], n[1]) === !1 && t.stopOnFalse && (l = o.length, n = !1);
                ...
                c = {
                    ...
                    remove: function () {
                        return xt.each(arguments, function (t, e) {
                            for (var n; (n = xt.inArray(e, o, n)) > -1;) o.splice(n, 1), n <= l && l--;
                        }), this;
                    },
                    has: function (t) {
        ...
        var Bt = function (t, e, n, i, r, o, s) {
                ...
                })), e)) for (; l < u; l++) e(t[l], n, s ? i : i.call(t[l], l, e(t[l], n)));
        ...
        xt.event = {
            ...
            add: function (t, e, n, i, r) {
                var o,
                    ...
                    g,
                    m = Ut.get(t);
                if (m) for (n.handler && (o = n, n = o.handler, r = o.selector), r && xt.find.matchesSelector(se, r), n.guid || (n.guid = xt.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function (e) {
            ...
            remove: function (t, e, n, i, r) {
                var o,
                    ...
                    p,
                    g,
                    m = Ut.hasData(t) && Ut.get(t);

                if (m && (l = m.events)) {
                    for (e = (e || "").match(jt) || [""], u = e.length; u--;) if (a = ue.exec(e[u]) || [], h = g = a[1], p = (a[2] || "").split(".").sort(), h) {
                    ...
                    } else for (h in l) xt.event.remove(t, h + e[u], n, i, !0);
            ...
            handlers: function (t, e) {
                var n,
                    ...
                    l = e.delegateCount,
                    u = t.target;
                if (l && u.nodeType && !("click" === t.type && t.button >= 1)) for (; u !== this; u = u.parentNode || this) if (1 === u.nodeType && ("click" !== t.type || u.disabled !== !0)) {
        ...
        xt.extend({
            ...
            clone: function (t, e, n) {
                ...
                if (!(St.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || xt.isXMLDoc(t))) for (s = E(a), o = E(t), i = 0, r = o.length; i < r; i++) H(o[i], s[i]);
                if (e) if (n) for (o = o || E(t), s = s || E(a), i = 0, r = o.length; i < r; i++) $(o[i], s[i]);else $(t, a);
                return s = E(a, "script"), s.length > 0 && x(s, !l && E(t, "script")), a;
            },
            cleanData: function (t) {
                for (var e, n, i, r = xt.event.special, o = 0; void 0 !== (n = t[o]); o++) if (qt(n)) {
                    if (e = n[Ut.expando]) {
                        if (e.events) for (i in e.events) r[i] ? xt.event.remove(n, i) : xt.removeEvent(n, i, e.handle);
                        n[Ut.expando] = void 0;
                    }
            ...
            stop: function (t, e, n) {
                ...
                return "string" != typeof t && (n = e, e = t, t = void 0), e && t !== !1 && this.queue(t || "fx", []), this.each(function () {
                    var e = !0,
                        ...
                        o = xt.timers,
                        s = Ut.get(this);
                    if (r) s[r] && s[r].stop && i(s[r]);else for (r in s) s[r] && s[r].stop && xe.test(r) && i(s[r]);
        ...
        xt.fn.extend({
            ...
            addClass: function (t) {
                ...
                if (e = nt(t), e.length) for (; n = this[l++];) if (r = et(n), i = 1 === n.nodeType && " " + tt(r) + " ") {
            ...
            toggleClass: function (t, e) {
                ...
                return "boolean" == typeof e && i ? e ? this.addClass(t) : this.removeClass(t) : _t(t) ? this.each(function (n) {
                    ...
                    var e, r, o, s;
                    if (i) for (r = 0, o = xt(this), s = nt(t); e = s[r++];) o.hasClass(e) ? o.removeClass(e) : o.addClass(e);else void 0 !== t && "boolean" !== n || (e = et(this), e && Ut.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || t === !1 ? "" : Ut.get(this, "__className__") || ""));
                });
            },
            hasClass: function (t) {
                var e,
                ...
                for (e = " " + t + " "; n = this[i++];) if (1 === n.nodeType && (" " + tt(et(n)) + " ").indexOf(e) > -1) return !0;
        ...
        xt.extend(xt.event, {
            trigger: function (t, e, i, r) {
                ...
                if (s = f = a = i = i || ct, 3 !== i.nodeType && 8 !== i.nodeType && !De.test(p + xt.event.triggered) && (p.indexOf(".") > -1 && (g = p.split("."), p = g.shift(), g.sort()), u = p.indexOf(":") < 0 && "on" + p, t = t[xt.expando] ? t : new xt.Event(p, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = g.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), e = null == e ? [t] : xt.makeArray(e, [t]), d = xt.event.special[p] || {}, r || !d.trigger || d.trigger.apply(i, e) !== !1)) {
                    ...
                    for (o = 0; (s = h[o++]) && !t.isPropagationStopped();) f = s, t.type = o > 1 ? l : d.bindType || p, c = (Ut.get(s, "events") || {})[t.type] && Ut.get(s, "handle"), c && c.apply(s, e), c = u && s[u], c && c.apply && qt(s) && (t.result = c.apply(s, e), t.result === !1 && t.preventDefault());
                ...
                var r,
                    ...
                    C = {
                        ...
                        getResponseHeader: function (t) {
                            ...
                            if (c) {
                                if (!a) for (a = {}; e = qe.exec(s);) a[e[1].toLowerCase()] = e[2];
                                e = a[t.toLowerCase()];
                            }
        ...
        xt.ajaxSetup({
            ...
            var r,
                o,
                s,
                a = t.jsonp !== !1 && (en.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && en.test(t.data) && "data");
            ...
            position: function () {
                if (this[0]) {
                    ...
                    if ("fixed" === xt.css(i, "position")) e = i.getBoundingClientRect();else {
    ...
    !function (o, s) {
        ...
        l.configure = function (t) {
            ...
            var i,
                o = n.querySelector(u.barSelector),
    ...
    Object.defineProperty(e, "__esModule", {
        ...
        function X(t, e) {
            ...
            var s = void 0 !== o ? o : e.gpuAcceleration,
                ...
                g = void 0,
                m = void 0;
            if (m = "bottom" === f ? "HTML" === a.nodeName ? -a.clientHeight + d.bottom : -l.height + d.bottom : d.top, g = "right" === h ? "HTML" === a.nodeName ? -a.clientWidth + d.right : -l.width + d.right : d.left, s && p) c[p] = "translate3d(" + g + "px, " + m + "px, 0)", c[f] = 0, c[h] = 0, c.willChange = "transform";else {
                var v = "bottom" === f ? -1 : 1,
                    y = "right" === h ? -1 : 1;
        ...
        for (var ct = "undefined" != typeof window && "undefined" != typeof document, dt = ["Edge", "Trident", "Firefox"], ft = 0, ht = 0; ht < dt.length; ht += 1) if (ct && navigator.userAgent.indexOf(dt[ht]) >= 0) {
            ft = 1;
            break;
        }
                ...
                return e = t, (n = [{
                    ...
                    value: function (t, e) {
                        if (this.handlers) {
                            var n,
                                i = this.handlers[t];
                            if (i) if (e) for (n = i.length - 1; 0 <= n; n--) i[n] == e && i.splice(n, 1);else i.length = 0;
                        }
                    }
                }, {
                    key: "unAll",
                ...
                v = function (t) {
                    ...
                    return function (t, e) {
                        ...
                        value: function (t, e, n, i) {
                            var r = this,
                                o = t;
                            if ("string" == typeof t) this.backend.load(o, this.mediaContainer, e, n);else {
                                var s = t;
                ...
                return this.each(function () {
                    ...
                    if (S.parent().hasClass(r.wrapperClass)) {
                        ...
                        if (k = S.siblings("." + r.barClass), x = S.siblings("." + r.railClass), a(), e.isPlainObject(n)) {
                            ...
                            if ("scrollTo" in n) _ = parseInt(r.scrollTo);else if ("scrollBy" in n) _ += parseInt(r.scrollBy);else if ("destroy" in n) return k.remove(), x.remove(), void S.unwrap();
                            o(_, !1, !0);
                        }
    ...
    !function (t, e, n) {
        ...
        function o() {
            ...
            for (var l in w) if (w.hasOwnProperty(l)) {
                if (t = [], e = w[l], e.name && (t.push(e.name.toLowerCase()), e.options && e.options.aliases && e.options.aliases.length)) for (n = 0; n < e.options.aliases.length; n++) t.push(e.options.aliases[n].toLowerCase());
        ...
        function c(t, n, i, r) {
            var o,
                ...
                f = s("div"),
                h = u();
            if (parseInt(i, 10)) for (; i--;) l = s("div"), l.id = r ? r[i] : d + (i + 1), f.appendChild(l);
        ...
        function f(t, e, n) {
            ...
            for (var o in t) if (t[o] in e) return n === !1 ? t[o] : (i = e[t[o]], r(i, "function") ? d(i, n || e) : i);
        ...
        function h(e, n, i) {
            ...
            if ("getComputedStyle" in t) {
                ...
                var o = t.console;
                if (null !== r) i && (r = r.getPropertyValue(i));else if (o) {
        ...
        function g(e, i) {
            ...
            if ("CSS" in t && "supports" in t.CSS) {
                for (; r--;) if (t.CSS.supports(p(e[r]), i)) return !0;
        ...
        function m(t, e, i, o) {
            ...
            for (h = t.length, f = 0; h > f; f++) if (p = t[f], m = B.style[p], l(p, "-") && (p = a(p)), B.style[p] !== n) {
        ...
        _.addTest("fullscreen", !(!F("exitFullscreen", e, !1) && !F("cancelFullScreen", e, !1))), _.addTest("filesystem", !!F("requestFileSystem", t)), S.testAllProps = y, _.addTest("cssanimations", y("animationName", "a", !0)), _.addTest("backgroundsize", y("backgroundSize", "100%", !0)), _.addTest("borderradius", y("borderRadius", "0px", !0)), _.addTest("borderimage", y("borderImage", "url() 1", !0)), _.addTest("boxshadow", y("boxShadow", "1px 1px", !0)), function () {
            ...
            M = function () {
                ...
                return n.toggle = function () {
                    ...
                    if (i) {
                        ...
                        if (r) {
                            if ("radio" === r.type) if (r.checked && this._element.classList.contains(N.ACTIVE)) t = !1;else {
            ...
            et = function () {
                ...
                return n.next = function () {
                    ...
                    return this.each(function () {
                        ...
                        if (i || (i = new t(this, r), e(this).data(R, i)), "number" == typeof n) i.to(n);else if ("string" == typeof o) {
        ...
        var gt = "dropdown",
            ...
            Nt = function () {
                ...
                return i.toggle = function () {
                    ...
                    if (!n || n.which !== xt && ("keyup" !== n.type || n.which === Ct)) for (var i = [].slice.call(document.querySelectorAll(At.DATA_TOGGLE)), r = 0, o = i.length; r < o; r++) {
            ...
            Ke = function () {
                ...
                return n.show = function () {
                    ...
                    if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && e(this._element).hasClass(Ye.ACTIVE) || e(this._element).hasClass(Ye.DISABLED))) {
                        var n,
                            i,
                            r = e(this._element).closest(Xe.NAV_LIST_GROUP)[0],
        ...
        t.fn.lightSlider = function (e) {
            ...
            return E.chbreakpoint = function () {
                if (l = t(window).width(), r.responsive.length) {
                    var e;
                    if (r.autoWidth === !1 && (e = r.item), l < r.responsive[0].breakpoint) for (var n = 0; n < r.responsive.length; n++) l < r.responsive[n].breakpoint && (u = r.responsive[n].breakpoint, c = r.responsive[n]);
                    if ("undefined" != typeof c && null !== c) for (var i in c.settings) c.settings.hasOwnProperty(i) && ("undefined" != typeof o[i] && null !== o[i] || (o[i] = r[i]), r[i] = c.settings[i]);
                ...
                if (r.autoWidth === !1) f = e * (S + r.slideMargin);else {
                    f = 0;
                ...
                initialStyle: function () {
                    ...
                    "fade" === r.mode && (r.autoWidth = !1, r.slideEndAnimation = !1), r.auto && (r.slideEndAnimation = !1), r.autoWidth && (r.slideMove = 1, r.item = 1), r.loop && (r.slideMove = 1, r.freeMove = !1), r.onBeforeStart.call(this, s), E.chbreakpoint(), s.addClass("lightSlider").wrap('<div class="lSSlideOuter ' + r.addClass + '"><div class="lSSlideWrapper"></div></div>'), g = s.parent(".lSSlideWrapper"), r.rtl === !0 && g.parent().addClass("lSrtl"), r.vertical ? (g.parent().addClass("vertical"), p = r.verticalHeight, g.css("height", p + "px")) : p = s.outerWidth(), a.addClass("lslide"), r.loop === !0 && "slide" === r.mode && (E.calSW(), E.clone = function () {
                        if (E.calWidth(!0) > p) {
                            ...
                            if (o < s.find(".clone.right").length) for (var u = a.length - 1; u > a.length - 1 - s.find(".clone.right").length; u--) m--, a.eq(u).remove();
                ...
                slideValue: function () {
                    var t = 0;
                    if (r.autoWidth === !1) t = m * ((S + r.slideMargin) * r.slideMove);else {
                        t = 0;
                ...
                touchMove: function (t, e) {
                    if (g.css("transition-duration", "0ms"), "slide" === r.mode) {
                        ...
                        if (i >= f - p - r.slideMargin) {
                            if (r.freeMove === !1) i = f - p - r.slideMargin;else {
                ...
                touchEnd: function (t) {
                    if (g.css("transition-duration", r.speed + "ms"), "slide" === r.mode) {
                        ...
                        var i = function (t) {
                            var n = 0;
                            if (e || t && (n = 1), r.autoWidth) for (var i = 0, o = 0; o < a.length && (i += parseInt(a.eq(o).width()) + r.slideMargin, m = o + n, !(i >= b)); o++);else {
                ...
                if (m > 0) r.onBeforePrevSlide.call(this, s, m), m--, s.mode(!1), r.gallery === !0 && i.slideThumb();else if (r.loop === !0) {
        ...
        !function () {
            ...
            e.prototype.init = function () {
                ...
                var n,
                    i,
                    r = null;
                if (this.s.dynamic ? this.s.dynamicEl[e].subHtmlUrl ? n = this.s.dynamicEl[e].subHtmlUrl : r = this.s.dynamicEl[e].subHtml : (i = this.$items.eq(e), i.attr("data-sub-html-url") ? n = i.attr("data-sub-html-url") : (r = i.attr("data-sub-html"), this.s.getCaptionFromTitleOrAlt && !r && (r = i.attr("title") || i.find("img").first().attr("alt")))), !n) if ("undefined" != typeof r && null !== r) {
                ...
                var r,
                    ...
                    f = function (e) {
                        ...
                        for (var a = t(window).width(), l = 0; l < n.length; l++) if (parseInt(n[l], 10) > a) {
                            o = i[l];
                            break;
                        }
                    };
                ...
                if (!c.$slide.eq(e).hasClass("lg-loaded")) {
                    if (g) c.$slide.eq(e).prepend('<div class="lg-video-cont lg-has-iframe" style="max-width:' + c.s.iframeMaxWidth + '"><div class="lg-video"><iframe class="lg-object" frameborder="0" src="' + o + '"  allowfullscreen="true"></iframe></div></div>');else if (d) {
                        var v = "";
    ...
    !function (t, e) {
        ...
        function c() {
            for (var t = L.length - 1; t >= 0; t--) if (L[t].inited) {
        ...
        function f(t) {
            ...
            for (var n = L.length - 1; n >= 0; n--) if (L[n].node !== t.node && L[n].parent.node === t.parent.node) {
                e = !1;
                break;
            }
        ...
        function I(t) {
            for (var e = L.length - 1; e >= 0; e--) if (L[e].node === t) return;
    ...
    !function (t, e, n, i) {
        ...
        var o = "stellar",
            ...
            u = function () {
                ...
                return "WebkitOpacity" in i && (r = "Webkit"), "KhtmlOpacity" in i && (r = "Khtml"), function (t) {
    ...
    window.JSON || (window.JSON = {}), function () {
        ...
        function str(t, e) {
            ...
            switch (l && "object" == typeof l && "function" == typeof l.toJSON && (l = l.toJSON(t)), "function" == typeof rep && (l = rep.call(e, t, l)), typeof l) {
                ...
                case "object":
                    ...
                    if (rep && "object" == typeof rep) for (o = rep.length, n = 0; n < o; n += 1) i = rep[n], "string" == typeof i && (r = str(i, l), r && s.push(quote(i) + (gap ? ": " : ":") + r));else for (i in l) Object.hasOwnProperty.call(l, i) && (r = str(i, l), r && s.push(quote(i) + (gap ? ": " : ":") + r));
                    return r = 0 === s.length ? "{}" : gap ? "{\n" + gap + s.join(",\n" + gap) + "\n" + a + "}" : "{" + s.join(",") + "}", gap = a, r;
            }
        }
        ...
        "function" != typeof JSON.stringify && (JSON.stringify = function (t, e, n) {
            ...
            function walk(t, e) {
                var n,
                    i,
                    r = t[e];
                if (r && "object" == typeof r) for (n in r) Object.hasOwnProperty.call(r, n) && (i = walk(r, n), void 0 !== i ? r[n] = i : delete r[n]);
        ...
        f.init = function () {
            ...
            if (f.initCore.initialized = !0, f.options = f.options || {}, f.options.hashChangeInterval = f.options.hashChangeInterval || 100, f.options.safariPollInterval = f.options.safariPollInterval || 500, f.options.doubleCheckInterval = f.options.doubleCheckInterval || 500, f.options.storeInterval = f.options.storeInterval || 1e3, f.options.busyDelay = f.options.busyDelay || 250, f.options.debug = f.options.debug || !1, f.options.initialTitle = f.options.initialTitle || i.title, f.intervalList = [], f.clearAllIntervals = function () {
                ...
                var e,
                    n = f.extractId(t.url);
                if (!n) if (e = f.getStateString(t), "undefined" != typeof f.stateToId[e]) n = f.stateToId[e];else if ("undefined" != typeof f.store.stateToId[e]) n = f.store.stateToId[e];else {
                ...
                if ("undefined" != typeof t ? f.busy.flag = t : "undefined" == typeof f.busy.flag && (f.busy.flag = !1), !f.busy.flag) {
                    ...
                    var e = function () {
                        var t, n, i;
                        if (!f.busy.flag) for (t = f.queues.length - 1; t >= 0; --t) n = f.queues[t], 0 !== n.length && (i = n.shift(), f.fireQueueItem(i), f.busy.timeout = s(e, f.options.busyDelay));
                    };
                ...
                var e,
                    n = f.extractState(i.location.href);
                ...
                var n;
                if (t > 0) for (n = 1; n <= t; ++n) f.forward(e);else {
    ...
    function i() {
        ...
        $.PaperPanel.layout = {
            ...
            $(document).on("click", t + " li a", function (t) {
                ...
                }), r.parent("li").removeClass("active");else if (r.is(".sub-menu") && !r.is(":visible")) {
