...
function AddSingle(props) {
        ...
        return (
            <div className="custom-float center" style={{width: "100%"}} key={index}>
                <div className="input-group-prepend d-inline-block center">
                    <div className="input-group-text text-dark text-capitalize font-weight-bold" data-tip
                         data-for={data_for}><i className="icon-money"/>{name}<small className="text-danger">*</small>
                    </div>
    ...
    const handleSubmit = (e) => {
        ...
        if (!file) {
            ...
            axios.post('api/beats/uploadBeat', bodyFormData, {headers: headers}).then(resp => {
    ...
    return (
        <Modal visible={true} width="700" height="auto" effect="fadeInUp">
            ...
            <ReactTooltip className="special-color-dark" id='silver_price' aria-haspopup='true'>
                <h5 className="text-center text-green"> Silver Lease (MP3 +
                    WAVE) {contract['silver_lease']['price']}$ </h5>
            ...
            <ReactTooltip className="special-color-dark" id='gold_price' aria-haspopup='true'>
                <h5 className="text-center text-green"> Gold Lease (MP3 + WAVE +
                    STEMS) {contract['gold_lease']['price']}$</h5>
            ...
            <ReactTooltip className="special-color-dark" id='platinum_price' aria-haspopup='true'>
                <h5 className="text-center text-green"> Platinum Lease (Unlimited +
                    Exclusive) {contract['silver_lease']['price']}$ </h5>
            ...
            <img
                alt={"logo"} src="https://zupimages.net/up/19/18/3ltf.png"
                style={{position: "absolute", marginTop: "5%", opacity: 0.4}}
            />
            <div className="form-material"
                 style={{background: "black", height: "100%", borderRadius: "5px", opacity: 0.7}}>
                    ...
                    <div className="body">
                        ...
                        <div className="custom-float">
                            {generateInput(
                                ...
                                "text",
                                "icon-user",
                                "Pour tagger d'autres artistes"
                            )}
                            <div className="input-group-prepend d-inline-block center" style={{width: "40%"}}>
                                <div className="input-group-text text-dark" data-tip="Définir le(s) genre(s) du beat">
                                    <i className="icon-text-width"/>&nbsp; Genre *
                                </div>
                                <input id="genre" name="genre" className="form-control"
                                       placeholder="Sélectionner le(s) genre(s)"
                                       value={genre} onChange={
                                    (e) => {
                                        Tools.changeFields(setGenre, e)
                                    }}
                                       list="music-genre" required/>
                        ...
                        <div className="custom-float">
                            <div className="input-group-prepend d-inline-block center" style={{width: "40%"}}>
                                <div className="input-group-text text-dark" data-tip="Upload here your beats_name.mp3">
                                    <i className="icon-music"/>&nbsp;Mp3 ou mpeg
                                </div>
                                <input onChange={
                                    (e) =>
                                        Tools.changeFileFields(setFile, e)
                                }
                                       id="file" name="file"
                            ...
                            <div className="input-group-prepend d-inline-block center" style={{width: "40%"}}>
                                <div className="input-group-text text-dark" data-tip="Upload here your beats photo">
                                    <i className="icon-picture-o"/>&nbsp;Photo
                                </div>
                                <input onChange={
                                    (e) =>
                                        Tools.changeFileFields(setPhoto, e)}
                                       id="photo"
                                       name="photo"
                                       className="form-control"
                            ...
                            <div className="custom-float">
                                <div className="input-group-prepend d-inline-block center" style={{width: "40%"}}>
                                    <div className="input-group-text text-dark"
                                         data-tip="Upload here your beats_name.wave"><i
                                        className="icon-music"/>&nbsp;Fichier wav *
                                    </div>
                                    <input onChange={
                                        (e) =>
                                            Tools.changeFileFields(setBeatsWave, e)}
                                           id="beats_wave"
                                           name="beats_wave"
                                           className="form-control"
                                           type="file"
                                ...
                                <div className="input-group-prepend d-inline-block center" style={{width: "40%"}}>
                                    <div className="input-group-text text-dark" data-tip="Upload here your beats stems">
                                        <i className="icon-music"/>&nbsp;Dossier stems (fichier zip)
                                    </div>
                                    <input onChange={
                                        (e) =>
                                            Tools.changeFileFields(setStems, e)}
                                           id="stems"
                                           name="stems"
                                           className="form-control"
                                           type="file"
                        ...
                        <div style={{display: "flex"}}>
                            {[['basic_price', 'basic', 'success-color'],
                                ['silver_price', 'silver', 'success-color'],
                                ['gold_price', 'gold', 'success-color'],
                                ['platinum_price', 'platinum', 'unique-color-dark']].map(
                                (val, index) =>
                        ...
                        <div className="custom-float">
                            <div className="input-group-prepend center" style={{width: "90%"}}>
                                <div className="input-group-text text-dark"
                                     data-tip="Ajouter quelque description si vous voulez"><i
                                    className="icon-crosshairs"/>&nbsp;    Description
                                </div>
                                <textarea value={description}
                                          onChange={
                                              (e) =>
                                                  Tools.changeFields(setDescription, e)}
                                          id="description"
                                          name="description"
                                          className="form-control"
                        ...
                        <button id="add-music"
                                className="btn btn-outline-success btn-sm pl-4 pr-4 mb-3"
                                onClick={(e) =>
                                    handleSubmit(e)}>{loading ? "Veuiller attendre ..." : "Enregister"}
                        </button>
                    </div>
                </div>
            </div>
