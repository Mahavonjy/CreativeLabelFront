...
import PersonalInformation from "../../../../cart/information/personalInformation";
import PurchaseInformation from "../../../../cart/information/purchaseInformation";
import Reservation from "../../../../cart/reservation/reservation";
import {
    addIslAmount,
    addServiceToShow,
    addThPrice,
...
function DisplayPrestation(props) {
    ...
    useEffect(() => {
        ...
        axios.post("api/reservation/check_total_price",
            ...
            dispatch(addTva(resp.data["tva"]));
            dispatch(addTotalAmount(resp.data["total_amount"]));
            dispatch(addIslAmount(resp.data["isl_amount"]));
            dispatch(addThPrice(resp.data["ht_price"]));
        });
    ...
    return (
        (Object.getOwnPropertyNames(service_to_show).length > 0)
