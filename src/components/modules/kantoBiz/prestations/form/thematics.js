    ...
    return (
        <div className="Base card mb-3 modal-prestation">
            ...
            <div className="row justify-content-center overflow-auto scrollbar-isl card-prestation">
                <div className="col-md-4 border card-thematique" style={{borderRadius: 10, background: "#58585a", height: 250}}>
                    <h4 className="text-red pt-3" style={{borderBottom: "2px solid black"}}>
                        ...
                        <i className="icon icon-info text-red"
                           data-tip="Sélectionner vos spécialités en accord avec la thématique"/>
                    </h4>
                    <div className="overflow-auto row justify-content-center"
                         style={{maxHeight: 165}} data-tip="Veuillez cliquer pour l'ajouter">
                        {options.map((val, index) =>
                            <span key={index} className="bg-brown m-1 text-center"
                                  style={{borderRadius: 10, width: 130, maxHeight: 21, cursor: "copy"}}
                ...
                <div className="col-md-4 border card-thematique" style={{borderRadius: 10, background: "#58585a", height: 250}}>
                    <h4 className="text-red" style={{borderBottom: "2px solid black"}}>Mes choix&nbsp;
                        <i className="icon icon-info text-red"
                           data-tip="La liste des spécialités que vous avez choisi en accord avec la thématique"/>
                    </h4>
                    <div className="overflow-auto row justify-content-center"
                         style={{maxHeight: 165, cursor: "not-allowed"}}
                         data-tip="Veuillez cliquer pour le supprimer">
                        {thematics_options_selected.map((val, index) =>
                            <span key={index} className="bg-brown m-1 text-center"
                                  style={{borderRadius: 10, width: 130, maxHeight: 21}}
