...
import ReservationPricingDetails from "./reservationPricingDetails";
        ...
        <div className="row text-center pt-5">
                    ...
                    <div className="flex-grow-0 text-center pt-3 mb-3">
                        ...
                        <div className="col pt-2 pb-2">
                            <div className="custom-float">
                                <div className="input-group-prepend d-inline-block w-100 center">
                                    <div className="input-group-text text-dark">
                                        <i className="icon-clock-1"/>&nbsp;Date
            ...
            <div className="col-md-8">
                ...
                <div className="flex-grow-0 text-center pb-3">
                    ...
                    <MuiPickersUtilsProvider utils={LocalizedUtils} locale={frLocale}>
                        {/* <Calendar noEdit value={date} onChange={changeDate}/> */}
